...
/**
 * Abstraction of an application level security intent derived from the ONOS intent definition
 */
@Beta
public abstract class SecurityIntent {

    private final SecurityIntentId id;
     ...
     */
    protected SecurityIntent(ApplicationId appId,
                     Key key,
        ...
        this.id = SecurityIntentId.valueOf(idGenerator.getNewId());
    ...
    public abstract static class Builder {
        ...
        protected Key key;
        protected int priority = SecurityIntent.DEFAULT_INTENT_PRIORITY;
         ...
         */
        protected Builder(SecurityIntent intent) {
        ...
        /**
         * Sets the application id for the security intent that will be built.
         *
        ...
        /**
         * Sets the key for the security intent that will be built.
         *
        ...
        /**
         * Sets the priority for the security intent that will be built.
         *
    ...
    public final boolean equals(Object obj) {
        ...
        final SecurityIntent other = (SecurityIntent) obj;
